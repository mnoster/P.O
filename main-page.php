...
<div id="wrapper" ng-controller="pageTopController as ptc">
    <div class="wrapper-inner">
            <div class="bg-top">
                <div class="bg-fade">
                    <h1 data-aos="fade-up"  style="margin:0; padding:20px 0 0 45px"><img class="main-logo" src="Images/Logomakr_0X15Cd.png"></h1>
                    <h1  data-aos="fade-down" class="title">Psych Origins</h1>
                    <hr>
                    <div class="intro"  data-aos="flip-up" data-aos-easing="ease-in-sine">Open-source academic database for researchers and mental health clinicians</div>
