        ...
        <div class="bg-bottom">
            <div>
                ...
                <div class=" col-xs-11 col-sm-5 info3">
                    <span>Clinicians</span><br>
                    Are you a clinician who would like to contribute to the PsychOrigins database?<br>
                    <hr style="margin:25px 0 ">
                    Go the<a href="#contact"> contact page </a>or send an email to support@psychorigins.com and
