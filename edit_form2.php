...
<div class="container pdf-form">
    <div class="container-fluid wrapper">
        ...
        <hr>
        <div class="row data">
            <div class="col-xs-12 col-sm-4"><strong> Age:</strong><br> <input class="form-control" value=""> <strong> Ethnicity:</strong><br> <input class="form-control" type="text" value="">
            </div>
            <div class="col-xs-12 col-sm-4">
                <strong> Gender:</strong><br> <input class="form-control" type="text" value=""><strong> Country:</strong><br> <input class="form-control" type="text" value="">
            </div>
            <div class="col-xs-12 col-sm-4">
                <strong> State:</strong><br> <input class="form-control" type="text" value=""> <strong> Employment:</strong><br><input class="form-control" type="text" value="">
            </div>
        ...
        <div class="row data">
            <div class="col-xs-12 col-sm-4">
                <strong> Relationship Status:</strong><br> <input class="form-control" type="text" value=""> <strong> Education:</strong><br> <input class="form-control" type="text" value="">
            </div>
            <div class="col-xs-12 col-sm-4">
                <strong> Sexual Orientation:</strong><br> <input class="form-control" type="text" value=""> <strong> Number of Children:</strong><br> <input class="form-control" type="text" value="">
            </div>
            <div class="col-xs-12 col-sm-4">
                <strong> Religious Affiliation:</strong><br> <input class="form-control" type="text" value=""> <strong> Status of your parents:</strong><br> <input class="form-control" type="text" value="">
            </div>
        </div>
        <hr>
        <div class="row data">
        ...
        <div class="row data">
            <div class="col-xs-12 col-sm-8">
                <strong> Combined years of therapy: </strong><br> <input class="form-control" type="text" value="">
